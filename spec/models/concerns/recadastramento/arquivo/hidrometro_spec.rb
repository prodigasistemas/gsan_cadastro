...
describe Recadastramento::Arquivo::Hidrometro do
  ...
  it '#hidrometro_infos' do
    hidrometro_arquivo = Recadastramento::Arquivo::Hidrometro.new hidrometro_marca, hidrometro_capacidade, hidrometro_protecao
  ...
  it '#hidrometro_infos sem medidor' do
    hidrometro_arquivo = Recadastramento::Arquivo::Hidrometro.new
