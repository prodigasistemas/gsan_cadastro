  ...
  describe "GET index" do
    context "quando a consulta" do
      ...
      context "retorna resultados" do
        ...
        it "retorna lista de tipos de endereco" do
      ...
      context "não retorna resultados" do
        ...
        it "retorna lista de tipos de endereco vazia" do
    ...
    context "quando a consulta não possuir filtros" do
      ...
      it "retorna a lista de tipos de endereco" do
        expect(json['endereco_tipos'].size).to eq 3
        expect(json['endereco_tipos'].collect{|l| l["descricao"]}).to include(endereco_tipos.first.descricao)
      end
    end
  ...
  describe "PUT update" do
    context "quando endereco_tipo é atualizado com sucesso" do
      ...
      it "retorna a endereco_tipo" do
        put :update, params: {id: 1, endereco_tipo: params}, format: :json
        expect(response).to be_successful
      end
    end
