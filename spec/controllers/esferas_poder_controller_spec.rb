  ...
  describe "GET index" do
    context "quando a consulta" do
      ...
      context "retorna resultados" do
        ...
        it "retorna lista de esferas do poder" do
      ...
      context "não retorna resultados" do
        ...
        it "retorna lista de esferas do poder vazia" do
    ...
    context "quando a consulta não possuir filtros" do
      ...
      it "retorna a lista de tipos de esferas do poder" do
        expect(json['esferas_poder'].size).to eq 3
        expect(json['esferas_poder'].collect{|l| l["descricao"]}).to include(esferas_poder.first.descricao)
      end
    end
  ...
  describe "PUT update" do
    context "quando a esfera de poder é atualizada com sucesso" do
      ...
      it "retorna a esfera de poder" do
        put :update, params: {id: 1, esfera_poder: params}, format: :json
        expect(response).to be_successful
      end
    end
