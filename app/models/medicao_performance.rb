class MedicaoPerformance < ActiveRecord::Base
  ...
  alias_attribute "valor_diferenca_consumo_agua",   "medp_vldifconsumoagua"
  alias_attribute "valor_diferenca_consumo_esgoto", "medp_vldifconsumoesgoto"
  alias_attribute "percentual_consumo_esgoto",      "medp_pcconsumoesgoto"
