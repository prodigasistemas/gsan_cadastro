class ImovelControleAtualizacaoCadastraisController < ApplicationController
  ...
  before_action :find_imovel_controle_atualizacao_cadastral, only: [:update]

  def show
    @imovel_controle_atualizacao_cadastral = ImovelControleAtualizacaoCadastral.find_by(id: params[:id])
  ...
  private
    ...
    def imovel_controle_atualizacao_cadastral_params
      params.require(:imovel_controle_atualizacao_cadastral).permit(:id, :imovel_id, :situacao_atualizacao_cadastral_id)
    end
