# -*- encoding: utf-8 -*-
# stub: exception_notification 4.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionmailer>.freeze, [">= 4.0", "< 6"])
      s.add_runtime_dependency(%q<activesupport>.freeze, [">= 4.0", "< 6"])
      s.add_development_dependency(%q<rails>.freeze, [">= 4.0", "< 6"])
      ...
      s.add_dependency(%q<actionmailer>.freeze, [">= 4.0", "< 6"])
